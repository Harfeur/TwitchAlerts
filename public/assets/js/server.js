function createAlert(alert, data) {
    ...
    let streamerIcon = $("<img class='rounded' width='50' height='50'>").attr("src", alert.icon);
    let streamerName = $("<span style='margin: 1em;'>").text(alert.name);
    let streamer = $("<td>").attr("data-label", $("#row-streamer").text()).append([streamerIcon, streamerName]);
    ...
    let discordHashtag = $('<svg class="channelIcon" width="24" height="24" viewBox="0 0 24 24">\n' +
        ...
        '</svg>');
    let channelName = $("<span>").text(alert.channel_name);
    ...
    let channel = $("<td>").attr("data-label", $("#row-channel").text()).append(channelLink);

    let start = $("<td class='modal-start-btn'>").attr("data-label", $("#row-start").text()).text(alert.start);
    let end = $("<td class='modal-end-btn'>").attr("data-label", $("#row-end").text()).text(alert.end);

    let editButton = $("<button class='btn btn-primary btn-sm modal-edit-btn' type='button' data-bs-toggle='modal' data-bs-target='#modal-edit'>")
        .text("Modifier")
        .on("click", () => {
            ...
            $("#form-edit").on("submit", function (e) {
                e.preventDefault();
                $("#form-edit [type='submit']").attr("disabled", true);
                ...
                $.post("/edit", {
                    ...
                    $("#form-edit [type='submit']").attr("disabled", false);
                }).fail(err => {
                    let alertMsg = $("<span>");
    ...
    let moveButton = $("<a class='dropdown-item modal-move-btn' href='#' data-bs-toggle='modal' data-bs-target='#modal-move'>")
        .text("Déplacer")
        .on("click", () => {
            $("#form-move").on("submit", function (e) {
                e.preventDefault();
                $("#form-move [type='submit']").attr("disabled", true);
                ...
                $.post("/move", {
                    ...
                    $("#form-move [type='submit']").attr("disabled", false);
                }).fail(err => {
                    let alertMsg = $("<span>");
                    let alert = $("<div class='alert alert-danger alert-dismissible' role='alert'>")
                        .append($("<button class='btn-close' type='button' data-bs-dismiss='alert' aria-label='Close'>"))
    ...
    let duplicateButton = $("<a class='dropdown-item modal-deuplicate-btn' href='#' data-bs-toggle='modal' data-bs-target='#modal-duplicate'>")
        .text("Dupliquer")
        .on("click", () => {
            ...
            $("#form-duplicate").on("submit", function (e) {
                e.preventDefault();
                $("#form-duplicate [type='submit']").attr("disabled", true);
                ...
                $.post("/create", {
                    ...
                    $("#form-duplicate [type='submit']").attr("disabled", false);
                }).fail(err => {
                    let alertMsg = $("<span>");
                    let alert = $("<div class='alert alert-danger alert-dismissible' role='alert'>")
                        .append($("<button class='btn-close' type='button' data-bs-dismiss='alert' aria-label='Close'>"))
    ...
    let deleteButton = $("<a class='dropdown-item modal-delete-btn' href='#' data-bs-toggle='modal' data-bs-target='#modal-delete'>")
        .text("Supprimer")
        .on("click", () => {
            $("#form-delete").on("submit", function (e) {
                e.preventDefault();
                $("#form-delete [type='submit']").attr("disabled", true);
                ...
                $.post("/delete", {
                    ...
                    $("#form-delete [type='submit']").attr("disabled", false);
                }).fail(err => {
                    let alertMsg = $("<span>");
                    let alert = $("<div class='alert alert-danger alert-dismissible' role='alert'>")
                        .append($("<button class='btn-close' type='button' data-bs-dismiss='alert' aria-label='Close'>"))
    ...
    let actions = $("<td>").attr("data-label", $("#row-actions").text()).append(
    ...
    $.get('/alerts', {
        ...
        $("#create-button").on('click', function () {
            $("#form-create").on("submit", function (e) {
                e.preventDefault();
                $("#form-create [type='submit']").attr("disabled", true);
                ...
                $.post("/create", {
                    ...
                    $("#form-create [type='submit']").attr("disabled", false);
                }).fail(err => {
                    let alertMsg = $("<span>");
                    let alert = $("<div class='alert alert-danger alert-dismissible' role='alert'>")
                        .append($("<button class='btn-close' type='button' data-bs-dismiss='alert' aria-label='Close'>"))
